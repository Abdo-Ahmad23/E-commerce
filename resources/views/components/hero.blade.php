...
<body class="blue container" style="overflow-x: hidden;">
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        @else
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn text-light dropdown-toggle" style="border:none;" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        {{ Auth::user()->name }}
                                                    </button>
                                                    <ul class="dropdown-menu" style="background-color:#000000;">
                                                        <li>
                                                            <a class="dropdown-item text-warning" href="{{route('dashboard')}}">Dashboard</a>
                                                        </li>
                                                        <li class="">
            ...
            <div data-aos="fade-up" data-aos-delay="100" class="col-s-12 col-lg-4 mt-4"
                ...
                <div
                    ...
                    <div>
                        ...
                        <p style="">
                            <btn class="btn btn-danger" data-bs-target="#home">Buy Online</btn>
                        </p>
                    </div>
                </div>
            </div>
            <div data-aos="fade-up" data-aos-delay="300" class="col-s-12 col-lg-4 mt-4"
                ...
                <div class="bg-danger"
                    ...
                    <div class="bg-danger">
                        ...
                        <p>Lorem ipsum dolor sit.</p>
                        <p style="">
                            <btn class="btn btn-warning" data-bs-target="#home">Buy Online</btn>
                        </p>
                    </div>
                </div>
            </div>
            <div data-aos="fade-up" data-aos-delay="500" class="col-s-12 col-lg-4 mt-4"
                ...
                <div class="bg-success"
                    ...
                    <div class="bg-success">
                        ...
                        <p>Lorem ipsum dolor sit.</p>
                        <p style="">
                            <btn class="btn btn-secondary" data-bs-target="#home">Buy Online</btn>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="category m-5" data-aos="fade-up" data-aos-delay="100" id="menu">
                    ...
                    <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card" style="background-color: transparent;">
                            <div class="images"
                                ...
                                id="changecolor">
                                <img src="https://darling-fairy-5f60d0.netlify.app/img/burger-3.png"
                                    class="card-img-top" alt="..." style="margin: auto;width: 30%;">

                            </div>
                            <div class="card-body">
                                <h1 class="text-center"
                                    style="font-size: 700;font-family: 'Oswald', sans-serif;color: white;"> BEEF BURGER
                                </h1>
                                <p class="text-white text-center">Crispy Onion Rings, Topped With Semi Dijon Mustard.
                                </p>
                                <h4 class="text-warning text-center">$42.00</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card" style="background-color: transparent;">
                            <div class="images"
                                style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                                id="changecolor">
                                <img src="https://darling-fairy-5f60d0.netlify.app/img/burger-2.png"
                                    class="card-img-top" alt="..." style="margin: auto;width: 30%;">
                    ...
                    <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card" style="background-color: transparent;">
                            <div class="images"
                                style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                                id="changecolor">
                                <img src="https://darling-fairy-5f60d0.netlify.app/img/burger-1.png"
                                    class="card-img-top" alt="..." style="margin: auto;width: 30%;">
                    ...
                    <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card" style="background-color: transparent;">
                            <div class="images"
                                style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                                id="changecolor">
                                <img src="https://darling-fairy-5f60d0.netlify.app/img/snack-1.png"
                                    class="card-img-top" alt="..." style="margin: auto;width: 30%;">
                    ...
                    <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card" style="background-color: transparent;">
                            <div class="images"
                                style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                                id="changecolor">
                                <img src="https://darling-fairy-5f60d0.netlify.app/img/snack-2.png"
                                    class="card-img-top" alt="..." style="margin: auto;width: 30%;">
                    ...
                    {{-- <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card" style="background-color: transparent;">
                            <div class="images"
                                style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                                id="changecolor">
                                <img src="https://darling-fairy-5f60d0.netlify.app/img/snack-3.png"
                                    class="card-img-top" alt="..." style="margin: auto;width: 30%;">
                    ...
                    {{-- <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card" style="background-color: transparent;">
                            <div class="images"
                                style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                                id="changecolor">
                                <img src="https://darling-fairy-5f60d0.netlify.app/img/snack-5.png"
                                    class="card-img-top" alt="..." style="margin: auto;width: 30%;">
                    ...
                    <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card" style="background-color: transparent;">
                            <div class="images"
                                style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                                id="changecolor">
                                <img src="https://darling-fairy-5f60d0.netlify.app/img/beverage-3.png"
                                    class="card-img-top" alt="..." style="margin: auto;width: 30%;">
        ...
        <!-- food only-->
        <div class="food mt-5 container d-none" id="option" data-aos="fade-up" data-aos-delay="100">
            <div class="row container">
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/burger-3.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-white text-center">Crispy Onion Rings, Topped With Semi Dijon Mustard.</p>
                            <h4 class="text-warning text-center">$42.00</h4>
                        </div>
                    </div>
                </div>
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/burger-2.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
                ...
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/burger-1.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
                ...
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/burger-5.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
                ...
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/burger-4.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
        ...
        <!-- snacks only -->
        <div class="snacks mt-5 container d-none" id="option" data-aos="fade-up" data-aos-delay="100">
            <div class="row container">
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/snack-1.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
                ...
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/snack-2.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
                ...
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/snack-3.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
                ...
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/snack-4.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
                ...
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/snack-5.png" class="card-img-top"
                                alt="..." style="margin: auto;width: 30%;">
        ...
        <!-- beverage only -->
        <div class="beverage mt-5 container d-none" id="option" data-aos="fade-up" data-aos-delay="100">
            <div class="row container">
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/beverage-1.png"
                                class="card-img-top" alt="..." style="margin: auto;width: 30%;">
                ...
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/beverage-2.png"
                                class="card-img-top" alt="..." style="margin: auto;width: 30%;">
                ...
                <div class="col-s-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="card" style="background-color: transparent;">
                        <div class="images"
                            style="width: 100%; display: flex;justify-content: center;background-color: #010D78;height: 10rem;"
                            id="changecolor">
                            <img src="https://darling-fairy-5f60d0.netlify.app/img/beverage-4.png"
                                class="card-img-top" alt="..." style="margin: auto;width: 30%;">
