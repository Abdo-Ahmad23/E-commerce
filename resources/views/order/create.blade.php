...
<body class="bg-warning">
    ...
    <h1 class="text-center text-danger my-5">Create New Order</h1>

    <form action="{{ route('order.store') }}" method="post" enctype="multipart/form-data" class="w-75 mx-auto my-5">
        @csrf
        ...
        <div class="my-2 form-group">
            ...
            <input value='{{ old('location') }}' type="url" class="form-control" name="location">
            @error('location')
                <p class="text-danger">
                    {{ $message }}
                </p>
        ...
        <input type="hidden" class="form-control" name="product_id" value="<?php $_SESSION['product_name']  ?>">

        {{-- <div class="my-2 form-group">
            <label for="product_id" class="mb-2">Product_id</label>
            <input value='{{ old('product_id') }}' type="text" class="form-control" name="product_id">
            @error('product_id')
                <p class="text-danger">
                    {{ $message }}
                </p>
        ...
        <input type="submit" value="Create Order" class="w-100 btn btn-success">
    </form>
