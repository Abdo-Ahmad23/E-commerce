...
class SnackController extends Controller
{
    ...
    {
        $snacks = Snack::all();
        return view('components.hero', compact('snacks'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            "image" => "mimes:jpg,jpeg,png,heic,gif|max:9000",
            "typeId"=>"required|numeric|exists:add_products,typeId"
        ]);
        $snack = $request->except('image');
